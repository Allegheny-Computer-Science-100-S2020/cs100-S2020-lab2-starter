...
public class ComputeMoonDistance {
  ...
  public static void main(String[] args) {
    ...
    // TODO: declare the variable that will be computed
    // NOTE: you are computing the yards to the moon
    // and the variable should have a suitably descriptive name

    // TODO: compute the yards to the moon
    // NOTE: you will need to write an assignment statement
    // for the variable that you declared in the previous code

    // output the declared values stored in variables
    System.out.println("Distance to the moon in miles: " + milesToMoon);
    System.out.println("Number of yards per mile: " + yardsPerMile);
    // TODO: output the computed value for the number of yards to the moon
    // NOTE: your println statement can follow the previous examples
  }
